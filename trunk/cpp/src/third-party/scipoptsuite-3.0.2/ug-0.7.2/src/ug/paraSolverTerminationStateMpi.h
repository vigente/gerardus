...
public:
   ...
   ParaSolverTerminationStateMpi(
         ...
         double       inDetTime                       /**< deterministic time, -1: should be non-deterministic */
             ...
             inRunningTime, inIdleTimeToFirstParaNode, inIdleTimeBetweenParaNodes, inIdleTimeAfterLastParaNode, inIdleTimeToWaitNotificationId, inIdleTimeToWaitAckCompletion,
