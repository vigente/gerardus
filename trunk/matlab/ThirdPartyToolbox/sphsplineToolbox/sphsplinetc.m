function answer = sphsplinetc (loni, lati, zi, lono, lato, p)
% SPHSPLINETC Gridding using a spherical surface spline in tension
%
% zo = sphsplinetc (loni, lati, zi, lono, lato[, p])
%
...
% This version uses the mex function SSSTc

% $Id: sphsplinetc.m,v 1.1.1.1 2008/05/09 21:34:52 myself Exp $
...
for i = 1:length (xo)
    ...
    answer(i) = zmean + zrange * SSSTc(g,p) * f;
end
