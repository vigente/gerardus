...
for I = 1:Ntri
    ...
    switch (nnz(isFreeloc))
        ...
        case 2 % 2 free vertices, 1 fixed vertex
            ...
            con{2*I} = sprintf( ...
                ' c%d: 0.5 x%d y%d - 0.5 x%d y%d - %.16g x%d + %.16g x%d + %.16g y%d - %.16g y%d >= %.16g', ...
        ...
        case 3 % three free vertices
            ...
            % constraint with lower bound
            con{2*I} = sprintf( ...
                ' c%d: -0.5 x%d y%d +0.5 x%d y%d +0.5 x%d y%d -0.5 x%d y%d -0.5 x%d y%d +0.5 x%d y%d >= %.16g', ...
