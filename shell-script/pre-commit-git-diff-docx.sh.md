...
pandoc -v &gt;/dev/null 2&gt;&1 || { echo &gt;&2 "I require pandoc to
keep track of changes in .docx files but it's not installed. Aborting.";
exit 1; }
...
of Markdown file
mdfile="${file%.docx}.md"  echo Creating Markdown copy of "$file" \#echo
"\$mdfile"
