...
disp('Ex0302: Perform Voxel Surfaces (CALD)')
...
InDataDir = [SpharmMatDir DataFolder '/Ex0302/hip02_fix'];


%% (2) List input file names
inFiles = dir([InDataDir '/*_fix.mat']); inNames={};
...
confs.OutDirectory = [SpharmMatDir DataFolder '/Ex0302/hip03_smo'];
