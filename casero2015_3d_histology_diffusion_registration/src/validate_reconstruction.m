...
%% CHOICE:
% low-res intra-histology: 4 registrations, 5 diffusions
T_INTRAHIST = ['t_Intra_' HISTOLO '.mat'];
% low-res intra-histology: 20 registrations, 1 diffusion (i.e. no diffusion)
T_INTRAHIST = ['t_IntraNoDiff_' HISTOLO '.mat'];
...
% load the intra-histology refinements
load(T_INTRAHIST_FILE, 'th2h', 'th2h_bsp')
...
for I = idx
    ...
    for J = L:-1:1
        ...
        err{I}(:, J) = sqrt(sum((xy{I,J} - ptsbf{I}).^2, 2));
